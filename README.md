...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypika-gis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14283&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypika-gis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypika-gis` can be installed with:

```
conda install pypika-gis
```

It is possible to list all of the versions of `pypika-gis` available on your platform with:
